...
class Opositive extends StatefulWidget {
  ...
  @override
  State<Opositive> createState() => OpositiveState();
}

class OpositiveState extends State<Opositive> {
  bool mapToggle;
  ...
  fetchdonors() async{
    var jsonResponse;
    jsonResponse = null;
    var response = await http.get(Uri.parse("http://10.0.2.2:5001/opositive"));
