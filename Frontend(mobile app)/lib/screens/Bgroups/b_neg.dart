...
class Bnegative extends StatefulWidget {
  ...
  @override
  State<Bnegative> createState() => BnegativeState();
}

class BnegativeState extends State<Bnegative> {
  bool mapToggle;
  ...
  fetchdonors() async{
    var jsonResponse;
    jsonResponse = null;
    var response = await http.get(Uri.parse("http://10.0.2.2:5001/bnegative"));
      ...
      return Center(
        child: Material(
          ...
          child: Column(
            children: [
              SizedBox(height: 100,),
              Text('B- Donors near you',textScaleFactor: 2,style: TextStyle(color: Colors.white),),
              Container(
