...
class Bpositive extends StatefulWidget {
  ...
  @override
  State<Bpositive> createState() => BpositiveState();
}

class BpositiveState extends State<Bpositive> {
  bool mapToggle;
  ...
  fetchdonors() async{
    var jsonResponse;
    jsonResponse = null;
    var response = await http.get(Uri.parse("http://10.0.2.2:5001/bpositive"));
