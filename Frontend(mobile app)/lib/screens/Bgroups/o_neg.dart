...
class Onegative extends StatefulWidget {
  ...
  @override
  State<Onegative> createState() => OnegativeState();
}

class OnegativeState extends State<Onegative> {
  bool mapToggle;
  ...
  fetchdonors() async{
    var jsonResponse;
    jsonResponse = null;
    var response = await http.get(Uri.parse("http://10.0.2.2:5001/onegative"));
      ...
      return Center(
        child: Material(
          ...
          child: Column(
            children: [
              SizedBox(height: 100,),
              Text('O- Donors near you',textScaleFactor: 2,style: TextStyle(color: Colors.white),),
              Container(
